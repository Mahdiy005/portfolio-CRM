            ...
            <div class="shadow dropdown-list dropdown-menu dropdown-menu-right animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3 dropdown-list-image">
                        <img class="rounded-circle" src="{{ asset('assets/dashboared') }}/img/undraw_profile_1.svg"
                            alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3 dropdown-list-image">
                        <img class="rounded-circle" src="{{ asset('assets/dashboared') }}/img/undraw_profile_2.svg"
                            alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3 dropdown-list-image">
                        <img class="rounded-circle" src="{{ asset('assets/dashboared') }}/img/undraw_profile_3.svg"
                            alt="...">
